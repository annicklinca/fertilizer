                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li> <a class="waves-effect waves-dark" href="index.php" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Dashboard</span></a>
                          ...
                          <li> <a class="waves-effect waves-dark" href="compare.php" aria-expanded="false"><i class="fa fa-smile-o"></i><span class="hide-menu">Analyse Data</span></a>
                        </li>
                        ...
                        <li> <a class="waves-effect waves-dark" href="budget.php" aria-expanded="false"><i class="fa fa-database-o"></i><span class="hide-menu">Budget</span></a>
                        </li>
