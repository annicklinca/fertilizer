                    ...
                    <div class="col-12">
                        <div class="card">
						 ...
						 <td><?php echo $row['request_id'] ; ?></td>
                          ...
                          <td><?php
                                    $userid=$row['id'];
                                   $quertwo=mysqli_query($conn,"SELECT * FROM user WHERE ROLE= 'retailer'");
                                    $rowtwo=mysqli_fetch_array($quertwo);
                                     echo  $rowtwo['id'].':'.$rowtwo['firstname'] ;
                             ?></td>
													<td><a class="btn btn-success" style="color: white;">Approved</a></td>
												</tr>
												<?php
												}
												?>
